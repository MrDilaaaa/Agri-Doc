              ...
              <TransitionGroup>
                ...
                >
                  <Switch>
                    ...
                    <Route path="/app/DSP" exact component={DSP} />
                    <Route path="/app/components/charts" exact component={Charts} />
                    <Route path="/app/IAP" exact component={IAP} />
                    <Route path="/app/components/maps" exact component={MapsGoogle} />
                    <Route path="/app/IPP" exact component={IPP} />
                    <Route path="/app/PDR" exact component={PDR} />
                  </Switch>
                </CSSTransition>
              </TransitionGroup>
              <footer className={s.contentFooter}>
              2021 © Agri-Doc - React made by Agri Group Members
              </footer>
            </main>
          </Hammer>
        </div>
