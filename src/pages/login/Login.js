    ...
    render() {
        ...
        return (
            <div className="auth-page">
                <Container>
                    <Widget className="widget-auth mx-auto" title={<h3 className="mt-0">Login to Agri-Doc</h3>}>
                        ...
                        <form onSubmit={this.doLogin}>
                            ...
                            <FormGroup className="mt">
                                ...
                                <InputGroup className="input-group-no-border">
                                    ...
                                    <Input id="email" className="input-transparent pl-3" value={this.state.email} onChange={this.changeEmail} 
